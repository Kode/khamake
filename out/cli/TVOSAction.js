...
class tvOSAction extends BuildAction_1.BuildAction {
    constructor() {
        super({
            actionName: Platform_1.Platform.tvOS,
    ...
    onExecute() {
        ...
        this._options.target = Platform_1.Platform.tvOS;
...
exports.tvOSAction = tvOSAction;
//# sourceMappingURL=TVOSAction.js.map