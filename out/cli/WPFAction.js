...
class WPFAction extends BuildAction_1.BuildAction {
    constructor() {
        super({
            actionName: Platform_1.Platform.WPF,
    ...
    onExecute() {
        ...
        this._options.target = Platform_1.Platform.WPF;
...
exports.WPFAction = WPFAction;
//# sourceMappingURL=WPFAction.js.map