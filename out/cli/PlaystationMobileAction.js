...
class PlayStationMobileAction extends BuildAction_1.BuildAction {
    constructor() {
        super({
            actionName: Platform_1.Platform.PlayStationMobile,
    ...
    onExecute() {
        ...
        this._options.target = Platform_1.Platform.PlayStationMobile;
...
exports.PlayStationMobileAction = PlayStationMobileAction;
//# sourceMappingURL=PlaystationMobileAction.js.map