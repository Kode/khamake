...
XnaExporter.prototype = Object.create(CSharpExporter.prototype);
XnaExporter.constructor = XnaExporter;

XnaExporter.prototype.sysdir = function () {
	return 'xna';
};

XnaExporter.prototype.backend = function () {
	return "XNA";
};

XnaExporter.prototype.exportResources = function () {
	this.createDirectory(this.directory.resolve(Paths.get(this.sysdir() + "-build", "Properties")));
	this.writeFile(this.directory.resolve(Paths.get(this.sysdir() + "-build", "Properties", "AssemblyInfo.cs")).toString());
...
XnaExporter.prototype.exportSLN = function (projectUuid) {
	...
	this.writeFile(this.directory.resolve(Paths.get(this.sysdir() + "-build", "ProjectContent.contentproj")));
...
XnaExporter.prototype.exportCsProj = function (projectUuid) {
	exportImage(findIcon(this.directory), this.directory.resolve(Paths.get(this.sysdir() + "-build", "GameThumbnail.png")), { width: 64, height: 64 });
	exportImage(findIcon(this.directory), this.directory.resolve(Paths.get(this.sysdir() + "-build", "Game.ico")), { }, 'ico');
