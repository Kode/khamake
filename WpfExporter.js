...
WpfExporter.prototype = Object.create(CSharpExporter.prototype);
WpfExporter.constructor = WpfExporter;

WpfExporter.prototype.sysdir = function () {
	return 'wpf';
};

WpfExporter.prototype.backend = function () {
	return "WPF";
};
...
WpfExporter.prototype.exportCsProj = function (projectUuid) {
